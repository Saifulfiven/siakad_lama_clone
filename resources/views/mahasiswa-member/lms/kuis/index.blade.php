            ...
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <div class="pull-right">
                        <a href="{{ route('mhs_lms_detail', ['id_jdk' => $r->id, 'id_dosen' => $id_dosen]) }}" class="btn btn-default btn-sm">Kembali</a>
                    </div>
                </header>
                        ...
                        <div class="col-md-12">
                            ...
                            @else
                                ...
                                @if ( $kuis_tertutup )
                                    ...
                                    @if ( Sia::telahMengerjakanKuis(Sia::sessionMhs(), $kuis->id) > 0 )
                                ...
                                @else
                                    ...
                                    @else
                                        ...
                                        @else
                                            ...
                                            @else
                                                <!-- KERJA -->
                                                <a href="{{ route('mhs_kuis_kerja', ['id_jdk' => $r->id, 'id_kuis' => $kuis->id, 'id_dosen' => $id_dosen]) }}" class="btn btn-primary kerja-kuis"><i class="fa fa-pencil"></i> Kerjakan Sekarang</a>
                                            @endif
...
<script>
    ...
    $(function () {
        ...
        var now = new Date("{{ Carbon::now()->format('Y-m-d H:i:s') }}");
              console.log('tgl:'+ now);
