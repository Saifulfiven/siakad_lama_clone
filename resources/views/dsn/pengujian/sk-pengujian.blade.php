	...
	<div class="print">
		...
		<ol type="a">
			<li>Bahwa untuk kelancaran proses pelaksanaan Tri Dharma Perguruan Tinggi pada {{ config('app.itb_long') }}, dipandang perlu untuk menetapkan Dosen
				Penguji dan mahasiswa tugas akhir/skrispi Tahun Akademik {{ $ta->nm_smt }}.
			</li>
		...
		<table border="0">
			...
			<tr>
				...
				<td> Menetapkan Dosen Penguji dan Mahasiswa Tugas Akhir/Skripsi Tahun Akademik {{ $ta->nm_smt }} sebagaimana terlampir dalam surat keputusan ini.</td>
			</tr>
		...
		<div class="pagebreak">
			...
			<center>
				<h4>DAFTAR DOSEN PENGUJI DAN MAHASISWA TUGAS AKHIR/SKRIPSI<br>
			...
			<table border="1" style="font-size: 11px;width:7.5in;border:1px solid #000">
				<tr>
					...
					<th>PRODI</th>
					<th style="min-width: 140px;">PENGUJI</th>
					<th>JUDUL</th>
				</tr>
