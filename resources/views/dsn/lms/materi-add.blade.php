        ...
        <div class="col-md-12">
          <section class="panel">
            <header class="panel-heading">
                Tambah Materi: <u>{{ $r->nm_mk }}</u>
            </header>
            <div class="panel-body" style="padding-top: 13px">

                <form action="{{ route('dsn_lms_materi_store') }}" id="form-add" method="post" data-collabel="3" data-alignlabel="left">
                    {{ csrf_field() }}
                    ...
                    <input type="hidden" class="sumber_materi" name="sumber_materi">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group" style="width: 50%" data-target="#modal-file" data-toggle="modal">
                                    <input type="text" class="form-control" id="file_materi" disabled="">
                                    <span class="input-group-btn">
                                        <button class="btn btn-default" type="button"><i class="fa fa-file"></i> Pilih File</button>
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <textarea cols="10" class="form-control" name="deskripsi" rows="4"></textarea>
                                </div>
                            </div>
                        </div>

                        <div class="col-md-12">
                            <button class="btn btn-primary btn-sm" id="btn-submit-add" style="margin: 3px 3px" ><i class="fa fa-floppy-o"></i> Simpan</button> &nbsp; &nbsp; 
