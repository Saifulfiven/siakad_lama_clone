        ...
        <div class="col-md-12">
          <section class="panel" style="padding-bottom: 50px">
            ...
            <div class="panel-body" style="padding-top: 13px">
                <a href="{{ route('m_kuis_detail', ['id_jadwal' => $r->id, 'id' => $kuis->id]) }}" class="btn btn-success btn-sm btn-block btn-loading">Kembali</a>
                <hr>

                <form action="{{ route('m_kuis_update_soal') }}" id="form-add" method="post" data-collabel="3" data-alignlabel="left">
                    {{ csrf_field() }}
        ...
        var options = {
            ...
            success:function(data, status, message) {
                if ( data.error == 1 ) {
                    ...
                    window.location.href="{{ route('m_kuis_edit_soal') }}/{{ $r->id }}/{{ $kuis->id }}/"+data.id_soal+"?id_kuis_soal={{ Request::get('id_kuis_soal') }}";
                }
            },
