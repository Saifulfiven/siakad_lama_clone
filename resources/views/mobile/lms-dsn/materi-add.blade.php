        ...
        <div class="col-md-12">
          <section class="panel">
            ...
            <div class="panel-body" style="padding-top: 13px">
                ...
                <form action="{{ route('dsnm_lms_materi_store') }}" id="form-add" method="post" data-collabel="3" data-alignlabel="left">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <a href="javascript:;" onclick="goBack()" style="margin: 3px 3px" class="btn btn-default btn-sm"><i class="fa fa-arrow-left"></i> Batal / Kembali</a>
