        ...
        <div class="table-responsive">
            <table border="0" class="table table-hover table-form">
                ...
                <tr>
                    ...
                    <td>
                        <?php if ( empty($ujian) && empty($ujian->pukul) && $ujian->tgl_ujian == '0000-00-00' ) { ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php if ( empty($ujian->pukul) && $ujian->tgl_ujian == '0000-00-00' ) { ?>
                            <div style="position: relative;">
                                <div class="input-icon right"> 
                        ...
                        <?php } else { ?>
                            <?= !empty($sekretaris) ? $sekretaris->nm_dosen : '' ?>
                        <?php } ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <?php } else { ?>
                            <?= !empty($anggota) ? $anggota->nm_dosen : '' ?>
                        <?php } ?>
                    </td>
                </tr>
                ...
                <?php if ( Session::get('ua_prodi') == '61101' ) { ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php } else { ?>
                                <?= !empty($anggota2) ? $anggota2->nm_dosen : '' ?>
                            <?php } ?>
                        </td>
                    </tr>
                <?php } ?>
    ...
    public function beritaAcara(Request $r)
    {
        ...
        $data['mhs'] = Sia::mahasiswa()
                ...
                ->select('m2.nim','m1.nm_mhs','m2.id_prodi','p.nm_prodi','p.jenjang',
                        'm2.bebas_pembayaran','m2.jurnal_file','m2.semester_mulai',
