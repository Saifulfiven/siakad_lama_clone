			...
			<div class="col-md-12">
				<div class="widget animated fadeInLeft delay-1">
					...
					<div class="widget-body">
							...
							<form action="{{ route('peta_store') }}" method="post" enctype="multipart/form-data" class="form-custom tab-content">
								{{ csrf_field() }}
								...
								<div class="row tab-pane active" role="tabpanel">
									<div class="form-group col-md-8 col-sm-12">
										...
										<input type="text" name="nama_peta" value="{{ old('nama_peta') }}" class="form-control">
									</div>
									...
									<div class="form-group col-md-4 col-sm-12">
										...
										<input type="file" name="gambar" accept="image/*" value="{{ old('gambar') }}" class="form-control">
									</div>
