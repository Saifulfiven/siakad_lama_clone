		...
		<div class="col-md-12">
			<section class="panel">
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-12">
							<form action="{{ route('m_dsn_bimbingan_store') }}" id="form-add-komentar" method="post" enctype="multipart/form-data">
					            {{ csrf_field() }}
    ...
    function submit(modul)
    {
        ...
        var options = {
            ...
            success:function(data, status, message) {
                window.location.href='{{ route('m_dsn_bimbingan', ['id_dosen' => $id_dosen, 'id_mhs_reg' => $mhs->id, 'id_smt' => Request::get('ta')]) }}';
            },
