		...
		<div class="row">
			<div class="col-md-12">
				<ul class="nav nav-tabs">
					...
					<li class="active"><a href="{{ route('keunggulan') }}">Keunggulan</a></li>
				...
				<div class="widget animated fadeInLeft delay-1">
					...
					<div class="widget-body" style="padding: 0 0 10px 0">
						...
						@if ( $keunggulan->count() > 0 )
							<?php $r = $keunggulan->first() ?>
							{{ Rmt::AlertSuccess() }}
							{{ Rmt::AlertError() }}
							{{ Rmt::AlertErrors($errors) }}
							<form action="{{ route('keunggulan_update') }}" method="post" class="form-custom tab-content">
								{{ csrf_field() }}
