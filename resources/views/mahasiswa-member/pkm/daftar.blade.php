        ...
        <div class="col-md-12">
          <section class="panel">
            ...
            <div class="panel-body" style="padding-top: 3px">
                ...
                <form action="{{ route('m_pkm_store') }}" id="form-pkm" method="post" data-collabel="3" data-alignlabel="left">
                    {{ csrf_field() }}
                                    ...
                                    @foreach( $anggota as $key => $val )
                                        <tr>
                                            ...
                                            <td align="center">
                                                ...
                                                <a href="{{ route('m_pkm_anggota_delete', ['index' => $key]) }}" onclick="return confirm('Anda ingin menghapus anggota ini?')" class="btn btn-danger btn-xs"><i class="fa fa-times"></i></a>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
                                ...
                                <table class="table table-bordered" style="min-width: 400px;width: 400px">
                                    ...
                                    @foreach( $pembimbing as $key => $val )
                                        <tr>
                                            ...
                                            <td>{{ $val['dosen'] }}</td>
                                            <td align="center">
                                                <a href="{{ route('m_pkm_dosen_delete', ['index' => $key]) }}" onclick="return confirm('Anda ingin menghapus pembimbing ini?')" class="btn btn-danger btn-xs"><i class="fa fa-times"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
