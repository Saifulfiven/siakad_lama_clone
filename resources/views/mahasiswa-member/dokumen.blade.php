                ...
                @foreach( $file as $r )
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <a href="{{ route('mhs_doc_download', ['id' => $r->id, 'file' => $r->judul]) }}">
                        ...
                        <td>
                            <span class="tooltip-area">
                                <a href="{{ route('mhs_doc_delete', ['id' => $r->id]) }}" onclick="return confirm('Anda ingin menghapus file ini?')" class="btn btn-theme btn-xs" title="Hapus"><i class="fa fa-times"></i></a>
                            </span>
                        </td>
                    </tr>
                @endforeach
