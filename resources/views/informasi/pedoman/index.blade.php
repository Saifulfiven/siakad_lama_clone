...
@section('contents')
	...
	<div class="content">
		<div class="row title-page">
			<div class="col-md-12">
				<h1>Pedoman Akademik &nbsp;<small>Daftar Pedoman Akademik</small></h1>
			</div>
		</div>
			...
			<div class="col-md-12">
				...
				<div class="widget animated fadeInLeft delay-1">
					...
					<div class="widget-option" style="margin-top: -15px;margin-right: 5px">
						<a href="{{ route('pedoman_create') }}" id="add-account">+ Pedoman Baru</a>
					</div>
	                                    ...
	                                    <div class="panel-heading" id="arrayOrder-{{ $r->id }}" 
	                                      ...
	                                      <h4 class="panel-title">
	                                          ...
	                                          <label class="pull-right">
	                                          		<a href="{{ route('pedoman_edit',['id' => $r->id]) }}" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i></a>
													<a href="javascript:;" class="btn btn-default btn-xs" onclick="Delete('{{ route('pedoman_delete', ['id' => $r->id])}}')"><i class="fa fa-trash-o"></i></a>
	                                          </label>
	                                      </h4>
...
@section('registerscript')
	...
	<script>
		...
		$('#add-account').attr('href','{{ route('pedoman_create') }}?order={{ $order }}');

        $("#list #primary-list").sortable({ opacity: 0.8, cursor: 'move', update: function() {
      
            	var order = $(this).sortable("serialize");
            	$.get('{{ route('pedoman_order') }}',{order:order})
