        ...
        <div class="col-md-12">
          <section class="panel">
            <header class="panel-heading">
                Ubah Catatan: <u>{{ $r->nm_mk }}</u>
            </header>
            <div class="panel-body" style="padding-top: 13px">

                <form action="{{ route('dsn_lms_catatan_update', $note->id) }}" id="form-add" method="post" data-collabel="3" data-alignlabel="left">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <textarea cols="10" id="deskripsi" class="form-control" name="konten" rows="12">{{ $note->konten }}</textarea>
                                </div>
                            </div>
        ...
        var options = {
            ...
            success:function(data, status, message) {
                if ( data.error == 1 ) {
                    ...
                    window.location.href="{{ route('dsnm_lms', ['id_jdk' => $r->id]) }}&id_dosen={{ $id_dosen }}";
                }
            },
