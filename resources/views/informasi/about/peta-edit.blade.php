			...
			<div class="col-md-12">
				<div class="widget animated fadeInLeft delay-1">
					<div class="widget-head">
						<h2 class="widget-title text-uppercase">
							...
							<div class="pull-right">
								<a href="{{ route('peta') }}" class="btn btn-primary btn-sm">Kembali</a>
							</div>
						</h2>
					</div>
					<div class="widget-body">
							...
							<form action="{{ route('peta_update') }}" method="post" enctype="multipart/form-data" class="form-custom tab-content">
								{{ csrf_field() }}
								...
								<div class="row tab-pane active" role="tabpanel">
									<div class="form-group col-md-8 col-sm-12">
										...
										<input type="text" name="nama_peta" value="{{ $r->judul }}" class="form-control">
									</div>
									...
									<div class="form-group col-md-4 col-sm-12">
										...
										<input type="file" name="gambar" class="form-control" accept="image/*"><br>
										<img src="{{ url('storage') }}/peta/{{ $r->gambar }}" width="100">
									</div>
