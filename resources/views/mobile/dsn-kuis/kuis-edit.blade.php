...
@section('content')
    ...
    $tgl_mulai = Carbon::parse($kuis->tgl_mulai)->format('d F Y H:i');
    $tgl_berakhir = Carbon::parse($kuis->tgl_tutup)->format('d F Y H:i');
        ...
        <div class="col-md-12">
          ...
          <section class="panel" style="padding-bottom: 50px">
            ...
            <div class="panel-body" style="padding-top: 13px">
                ...
                <a href="{{ route('m_kuis_detail', ['id_jadwal' => $r->id, 'id' => $kuis->id]) }}" class="btn-loading btn btn-success btn-sm pull-right"><i class="fa fa-list"></i> Batal / Kembali</a>
                <div class="clearfix"></div>
                <hr>

                <form action="{{ route('m_kuis_update') }}" id="form-add" method="post" data-collabel="3" data-alignlabel="left">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div>
                                            <div class="input-group">
                                                <input type="text" name="waktu" id="waktu" value="{{ $kuis->waktu_kerja }}" class="form-control">
                        ...
                        <div class="col-md-12">
                            ...
                            <a href="{{ route('m_kuis_detail', ['id_jadwal' => $r->id, 'id' => $kuis->id]) }}" style="margin: 3px 3px" class="btn-loading btn btn-default btn-sm"><i class="fa fa-list"></i> Batal / Kembali</a>
                        </div>
