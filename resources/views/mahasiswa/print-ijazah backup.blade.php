    ...
    <div class="kontainer">
        ...
        <center>
            ...
            <p class="paragraf">
                ...
                Sarjana (S1)<br>
                pada Program Studi {{ $prodi->nm_prodi }} Institut Teknologi & Bisnis (ITB) Nobel Indonesia.<br>
        ...
        <table width="100%" border="0" align="center" style="margin-top: 15px" class="footer">
            <tr>
                <td width="155px"></td>
                <td width="300px" style="font-size: 11pt"><br><b>REKTOR</b></td>
                <td width="180px">&nbsp;</td>
