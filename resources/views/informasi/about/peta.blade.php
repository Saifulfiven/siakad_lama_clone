		...
		<div class="row">
			<div class="col-md-12">
				<ul class="nav nav-tabs">
					...
					<li class="active"><a href="{{ route('peta') }}">Peta</a></li>
				</ul>
				...
				<div class="widget animated fadeInLeft delay-1">
					...
					<div class="widget-option" style="margin-top: -15px;margin-right: 5px">
						<a href="{{ route('peta_create') }}" id="add-account">+ Peta Baru</a>
					</div>
	                                    ...
	                                    <div class="panel-heading" id="arrayurutan-{{ $r->id }}" 
	                                      ...
	                                      <h4 class="panel-title">
	                                          ...
	                                          <label class="pull-right">
	                                          		<a href="{{ route('peta_edit', ['id' => $r->id]) }}" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i></a>
													<a href="javascript:;" class="btn btn-default btn-xs" onclick="Delete('{{ route('peta_delete', ['id' => $r->id])}}')"><i class="fa fa-trash-o"></i></a>
	                                          </label>
	                                      </h4>
