...
<html>
<head>
	<title>Cetak Jadwal Antara</title>
...
<div class="col-md-12">
	...
	<table border="0">
		<tr>
			...
			<td>: {{ is_array(Session::get('jda_smt')) ? implode(',',Session::get('jda_smt')) : 'Semua' }}</td>
		</tr>
		<tr>
			<td>Program Studi</td>
			<td>: {{ is_array(Session::get('jda_prodi')) ? implode(',',Session::get('jda_prodi')) : 'Semua' }}</td>
		</tr>
	</table>
