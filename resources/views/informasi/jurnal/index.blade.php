...
@section('contents')
	...
	<div class="content">
		<div class="row title-page">
			<div class="col-md-12">
				<h1>Jurnal &nbsp;<small>Daftar dokumen jurnal</small></h1>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="widget animated fadeInLeft delay-1">
					...
					<div class="widget-option" style="margin-top: 5px;margin-right: 5px"><a href="{{ route('jurnal_create') }}" id="add-account">+ Dokumen Baru</a></div>
								...
								@if ( $jurnal->total() > 0 )
									...
									<table class="table lists absen">
										<tr class="first">
											...
											<td colspan="2">Tandai Semua &nbsp;&nbsp;&nbsp;&nbsp;<a href="#" class="delete" onclick="DeleteMassal('check', '{{ route('jurnal_delete') }}')"><i class="fa fa-trash-o"></i>&nbsp; Hapus</a></td>
										</tr>
											...
											<tr>
												...
												<td class="text-right action">
													<div class="btn-group" role="group">
														...
														<a href="{{ route('jurnal_edit',['id' => $r->id]) }}" class="btn btn-default"><i class="fa fa-pencil"></i></a>
														<a href="javascript:;" class="btn btn-default" onclick="Delete('{{ route('jurnal_delete', ['id' => $r->id])}}')"><i class="fa fa-trash-o"></i></a>
													</div>
												</td>
											</tr>
										@endforeach
