		...
		<div class="row">
			<div class="col-md-12">
				<ul class="nav nav-tabs">
					...
					<li class="active"><a href="{{ route('prodi') }}">Prodi</a></li>
				...
				<div class="widget animated fadeInLeft delay-1">
					...
					<div class="widget-body" style="padding: 0 0 10px 0">
							...
							<form action="{{ route('prodi_update') }}" method="post" class="form-custom tab-content">
								@if ( $prodi_sarjana->count() > 0 )
									<?php $r = $prodi_sarjana->first() ?>
									{{ csrf_field() }}
								...
								@else
									Belum ada data
								@endif
								@if ( $prodi_pascasarjana->count() > 0 )
									<?php $r = $prodi_pascasarjana->first() ?>
