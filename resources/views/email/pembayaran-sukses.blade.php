                                ...
                                <table style="{{ $style['email-body_inner'] }}" align="center" width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                            ...
                                            <div style="padding: 5px; border: 1px dashed #c9c972;background-color: #fdfdf5;border-radius: 5px">
                                                <table style="font-size: 13px;{{ $fontFamily }}">
                                                    <tr>
                                                ...
                                                <div style="text-align: center; font-size: 13px">
                                                    <p><b>Terima Kasih</b><br>Apabila terdapat kendala dalam atau pertanyaan mengenai sistem pembayaran,<br> silahkan email ke <b>nobel@stienobel-indonesia.ac.id</b><br> dengan subjek "Pembayaran SIAKAD"</p>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
