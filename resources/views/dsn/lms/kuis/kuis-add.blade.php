        ...
        <div class="col-md-12">
          <section class="panel" style="padding-bottom: 50px">
            ...
            <div class="panel-body" style="padding-top: 13px">
                ...
                <form action="{{ route('kuis_store') }}" id="form-add" method="post" data-collabel="3" data-alignlabel="left">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <hr>
                            <button class="btn btn-primary btn-sm" id="btn-submit-add" onclick="CKupdate()" style="margin: 3px 3px" ><i class="fa fa-floppy-o"></i> Lanjutkan & Buat Soal</button> &nbsp; &nbsp; 
        ...
        var options = {
            ...
            success:function(data, status, message) {
                if ( data.error == 1 ) {
                    ...
                    window.location.href="{{ route('kuis_detail') }}/{{ $r->id }}/"+data.id;
                }
            },
