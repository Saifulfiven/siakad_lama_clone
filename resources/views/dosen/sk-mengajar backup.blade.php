...
$bulan = substr($today, 6,2);
$tahun_sk = substr($today,0,4);
...
@if ( empty(Request::get('all')) )
	<div class="print">
		<center>
			...
			<p>Ketua STIE <span class="cl">Nobel Indonesia</span></p>
		...
		<ol type="a">
			<li>Bahwa untuk menjamin kelancaran jalannya perkuliahan serta ujian semester
				pada STIE <span class="cl">Nobel Indonesia</span>, maka dipandang perlu menetapkan
		...
		<ol>
			<li>SK. Menteri Pendidikan dan Kebudayaan RI. No. 028/D/O/1999, tertanggal 23 Februari 1999 
				tentang pendirian STIE <span class="cl">Nobel Indonesia</span>.</li>
			<li>Peraturan Pemerintah No. 60 tahun 1999.</li>
			<li>Statuta STIE <span class="cl">Nobel Indonesia</span>.</li>
		</ol>

		<center><h4>MEMUTUSKAN</h4></center>

		<p style="margin:1px">Menetapkan : </p>
		<p>Pertama : Bahwa Saudara/i : <b> <?= Sia::namaDosen($dsn->gelar_depan,$dsn->nm_dosen,$dsn->gelar_belakang) ?></b> ditugaskan sebagai Dosen Pengasuh Mata Kuliah Pada STIE Nobel Indonesia
		...
		<table border="1" style="font-size: 11px;width:7.5in;border:1px solid #000">
			<tr>
				...
				<th rowspan="2">SKS</th>
				<th colspan="{{ Sia::getFakultasUser() == 2 ? 3 : 2 }}" style="padding:0px">JADWAL</th>
		...
		<table border="0">
			<tr>
				...
				<td> Kepadanya diberikan honorarium sesuai dengan peraturan yang berlaku dalam lingkup Statuta STIE <span class="cl">Nobel Indonesia</span>.</td>
			</tr>
			<tr>
		...
		<table border="0">
			...
			<tr>
				<td></td>
				<td colspan="3">STIE <span class="cl">Nobel Indonesia</span></td>
			</tr>
			<tr>
		...
		<div style="font-size: 10px">
			<i>Tambusan :</i>
			<ol>
				<li>Ketua Yayasan Pendidikan Nobel Indonesia</li>
				<li>Bendahara Yayasan Pendidikan Nobel Indonesia</li>
