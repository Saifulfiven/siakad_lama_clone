...
$ta = DB::table('semester')->where('id_smt', Session::get('pgj.smt'))->first();
...
?>
	...
	<div class="print">
		...
		<center>
			...
			<p><b>PENETAPAN DOSEN PENGUJI DAN MAHASISWA<br>
				TUGAS AKHIR/TESIS TAHUN AKADEMIK {{ strtoupper($ta->nm_smt) }}  </b></p>
			<p><b>DIREKTUR PROGRAM PASCASARJANA {{ strtoupper(config('app.itb_long')) }}</b></p>
		...
		<ol type="a">
			<li>Bahwa untuk kelancaran proses pelaksanaan Tri Dharma Perguruan Tinggi pada {{ config('app.itb_long') }}, dipandang perlu untuk menetapkan Dosen
				Penguji dan mahasiswa tugas akhir/tesis Tahun Akademik {{ $ta->nm_smt }}.
			</li>
			<li>Bahwa Dosen Penguji tugas akhir/skripsi yang tercantum namanya dalam Lampiran Keputusan ini, dipandang mampu untuk melaksanakan tugas yang diberikan.
			</li>
			<li>
		...
		<table border="0">
			...
			<tr>
				...
				<td> Menetapkan Dosen Penguji dan Mahasiswa Tugas Akhir/Tesis Tahun Akademik {{ $ta->nm_smt }} sebagaimana terlampir dalam surat keputusan ini.</td>
			</tr>

			<tr>
				<td valign="top" width="100">Kedua</td>
				<td valign="top" width="20">: </td>
				<td> Kepada Para Penguji akan diberikan honorarium sesuai peraturan yang berlaku pada {{ config('app.itb_long') }}.</td>
			</tr>
			<tr>
		...
		<table border="0">
			...
			<tr>
				<td></td>
				<td colspan="3"><b>DIREKTUR PPS<br> {{ config('app.itb_long') }}</b></td>
			</tr>
			<tr>
				<td></td>
				<td colspan="3" class="stempel-box">
					<img class="stempel" src="{{ url('resources') }}/assets/img/stempel-itb2.png">
					<img src="{{ url('resources') }}/assets/img/ttd-maryadi.png" width="200">
				</td>
			</tr>
			<tr>
				<td></td>
		...
		<div class="pagebreak">
			...
			<center>
				<h4>DAFTAR DOSEN PENGUJI DAN MAHASISWA TUGAS AKHIR/TESIS<br>
			...
			<table border="1" style="font-size: 11px;width:7.5in;border:1px solid #000">
				<tr>
					...
					<th>MAHASISWA</th>
					<th>PRODI</th>
					<th style="min-width: 200px;">Penguji</th>
					<th>JUDUL</th>
				</tr>
        {{-- {{ dd($bimbingan) }} --}}
			...
			<table border="0" width="100%">
				...
				<tr>
					<td></td>
					<td colspan="3"><b>DEKAN PPS<br> {{ config('app.itb_long') }}</b></td>
				</tr>
				<tr>
					<td></td>
					<td colspan="3" class="stempel-box">
