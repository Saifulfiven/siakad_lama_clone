...
?>
	...
	<div class="print">
		...
		<center>
			...
			<p><b>DEKAN FAKULTAS PASCASARJANA {{ strtoupper(config('app.itb_long')) }}</b></p>
		...
		<ol type="a">
			<li>Bahwa untuk kelancaran proses pelaksanaan Tri Dharma Perguruan Tinggi pada {{ config('app.itb_long') }}, dipandang perlu untuk menetapkan Dosen
				Pembimbing dan mahasiswa bimbingan tugas akhir/tesis Tahun Akademik {{ $ta->nm_smt }}.
			</li>
		...
		<table border="0">
			...
			<tr>
				...
				<td> Menetapkan Dosen Pembimbing dan Mahasiswa Bimbingan Tugas Akhir/Tesis Tahun Akademik {{ $ta->nm_smt }} sebagaimana terlampir dalam surat keputusan ini.</td>
			</tr>
		...
		<table border="0">
			...
			<tr>
				<td></td>
				<td colspan="3"><b>DEKAN FAKULTAS PASCASARJANA<br> {{ config('app.itb_long') }}</b></td>
			</tr>
			<tr>
				<td></td>
		...
		<div class="pagebreak">
			...
			<center>
				<h4>DAFTAR DOSEN PEMBIMBING DAN MAHASISWA BIMBINGAN TUGAS AKHIR/TESIS<br>
			...
			<table border="1" style="font-size: 11px;width:7.5in;border:1px solid #000">
				<tr>
					...
					<th>MAHASISWA</th>
					<th>PRODI</th>
					<th style="min-width: 200px;">PEMBIMBING</th>
					<th>JUDUL</th>
				</tr>
