...
trait MobileKuisController
{

    public function m_detail(Request $r, $id_jadwal, $id)
    {
        ...
        return view('mobile.dsn-kuis.detail', $data);
    }

    public function m_add(Request $r, $id)
    {
    	if ( !Session::has('m_id_dosen') ) {
    		Session::set('m_id_dosen', $r->id_dosen);
    	}
        ...
        $jenis_ujian = $this->jenisUjian(Rmt::semesterBerjalan()->id_smt);
        ...
        return view('mobile.dsn-kuis.kuis-add', $data);
    }
    ...
    public function m_addSoal(Request $r, $id, $id_kuis)
    {
        $data['kuis'] = Kuis::findOrFail($id_kuis);
        $data['r'] = $this->jadwal($id);

        return view('mobile.dsn-kuis.add-soal', $data);
    }

    public function m_soalStore(Request $r)
    {
        $this->validate($r, [
            'judul' => 'required',
            'soal' => 'required'
    ...
    public function m_editSoal(Request $r, $id, $id_kuis, $id_soal)
    {
        $data['kuis'] = Kuis::findOrFail($id_kuis);
        ...
        return view('mobile.dsn-kuis.edit-soal', $data);
    }

    public function m_updateSoal(Request $r)
    {
        $this->validate($r, [
            'judul' => 'required',
            'soal' => 'required'
    ...
    public function m_deleteSoal($id_kuis_soal, $id_jadwal)
    {
    ...
    public function m_bankSoal(Request $r)
    {
        $data = BankSoal::where('id_dosen', $this->sessionDsn())
            ...
            <tbody align="center">
                <?php foreach( $data as $val ) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= route('m_kuis_ambil_soal', ['id_soal' => Rmt::engkripAngka($val->id), 'id_kuis' => $r->id_kuis]) ?>" class="btn-loading btn btn-primary btn-xs ambil">AMBIL</a> 
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
    ...
    public function m_ambilSoal($id_soal, $id_kuis)
    {
    ...
    public function m_jawaban(Request $r, $id_jadwal, $id)
    {
        ...
        return view('mobile.dsn-kuis.jawaban', $data);
    }

    public function m_jawabanDetail(Request $r, $id_jadwal, $id, $id_peserta)
    {
        ...
        return view('mobile.dsn-kuis.jawaban-detail', $data);
    }


    public function m_edit(Request $r, $id, $id_kuis)
    {
        $data['kuis'] = Kuis::findOrFail($id_kuis);
        $data['r'] = $this->jadwal($id);

        return view('mobile.dsn-kuis.kuis-edit', $data);
    }
    ...
    public function m_grade(Request $r, $id_jadwal, $id_peserta)
    {
        try {
  ...
  //   }
	...
	public static function jmlPesertaKelas($id_jdk)
	{
    ...
    public static function jumlahMengerjakanKuis($id_kuis)
    {
    ...
    public static function sessionDsn()
    {
    	return Session::get('m_id_dosen');
    }
}