                                ...
                                <div class="tab-pane fade in active" id="file">
                                    ...
                                    <div id="uploaded-video" <?= Session::has('id_video') ? '':'style="display: none"' ?>>
                                        @if ( Session::has('id_video') )
                                            ...
                                            <a href="{{ route('video_delete_tmp') }}" onclick="return confirm('Anda ingin membatalkan video ini?')" class="btn btn-danger btn-xs"><i class="fa fa-times"></i> Hapus</a>
                                        @else
                                    ...
                                    <div id="form-upload" <?= Session::has('id_video') ? 'style="display: none"':'' ?>>
                                        <form action="{{ route('video_upload') }}" enctype="multipart/form-data" method="post" class="dropzone" id="dropzone">
                                            {{ csrf_field() }}
                                            <input type="hidden" name="id_jadwal" value="{{ $r->id }}">
                                            <div class="fallback">
                                            </div>
