          ...
          <section class="panel">
            <header class="panel-heading">
                ...
                <div class="pull-right">
                    <a href="javascript:;" onclick="return window.history.back()" class="btn btn-default btn-xs">Kembali</a>
                </div>
            </header>
            <div class="panel-body" style="padding-top: 13px">
                ...
                <?php
                    ...
                    $url = !empty($jwb) ? route('mhs_lms_tugas_update') : route('mhs_lms_tugas_store');
                    ...
                    <div class="col-md-12" style="margin-top: 20px;">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    <td>Jumlah Max. Kirim Jawaban</td>
                                ...
                                <tr>
                                    <td>Tanggal Mulai</td>
                                    <td>: {{ !empty($tugas->mulai_berlaku) ? Rmt::tgl_indo($tugas->mulai_berlaku).' '.substr($tugas->mulai_berlaku, 11, 5).' WITA' : 'Tidak terbatas' }} </td>
                                </tr>
                                <tr>
                                    <td>Tanggal Jatuh Tempo</td>
                                    <td>: {{ !empty($tugas->tgl_berakhir) ? Rmt::tgl_indo($tugas->tgl_berakhir).' '.substr($tugas->tgl_berakhir, 11, 5).' WITA' : 'Tidak terbatas' }} </td>
                                </tr>
                                @if ( $tugas_terbuka )
                                    <tr>
                                        <td>Sisa waktu</td>
                        ...
                        @if ( $tugas_terbuka )
                            ...
                            @if ( !empty($tugas->file) )
                                ...
                                <a href="{{ route('mhs_lms_tugas_view_att', ['id_tugas' => $tugas->id,'id_dosen' => $tugas->id_dosen ,'file' => $tugas->file]) }}" target="_blank">{{ $tugas->file }}</a>
                            @endif
                        ...
                        @if ( !empty($tugas->tgl_tutup) && Carbon::now() >= $tugas->tgl_tutup )
                            ...
                            @if ( !empty($file) )
                                <p>File yang kamu upload {{ $updated_at }}</p>
                                <a href="{{ route('mhs_lms_tugas_download', ['id_tugas' => $tugas->id, 'file' => $file, 'jdk' => $r->id]) }}">
                                    ...
                                    <form action="{{ $url }}" id="form-add" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6" style="padding: 0">
                                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <span class="fileinput-new">Klik untuk upload file</span>
                                            ...
                                            @if ( $btn_submit )
                                                <div class="col-md-12">
                                                    <hr>
                                                    <button onclick="CKupdate()" class="btn btn-primary btn-sm" id="btn-submit-add" onclick="CKupdate()" style="margin: 3px 3px" ><i class="fa fa-floppy-o"></i> Simpan</button> &nbsp; &nbsp; 
                                                    <a href="javascript:;" onclick="window.history.back()" style="margin: 3px 3px" class="btn btn-default btn-sm"><i class="fa fa-list"></i> Batal / Kembali</a>
                                                </div>
                                            @endif
