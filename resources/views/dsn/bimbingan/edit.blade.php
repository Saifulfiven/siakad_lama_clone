		...
		<div class="col-md-12">
			<section class="panel">
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-12">
							<form action="{{ route('dsn_bim_update_komentar') }}" id="form-add-komentar" method="post" enctype="multipart/form-data">
					            {{ csrf_field() }}
					            ...
					            <div class="form-group row">
					                ...
					                <div class="col-md-6">
					                    ...
					                    @if ( !empty($bim->file) )
					                    	<br>{{ $bim->file }}
					                    	<a href="{{ route('dsn_bim_delete_lampiran', ['id' => $bim->id]) }}" onclick="return confirm('Anda ingin menghapus lampiran ini?')" class="btn btn-danger btn-xs">Hapus Lampiran</a>
					                    @endif
					               </div>
    ...
    function submit(modul)
    {
        ...
        var options = {
            ...
            success:function(data, status, message) {
                window.location.href='{{ route('dsn_bim_detail', ['id_mhs_reg' => Request::get('mhs'), 'id_smt' => Request::get('ta')]) }}';
            },
