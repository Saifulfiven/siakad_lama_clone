        ...
        <div class="col-md-12">
          <section class="panel">
            ...
            <div class="panel-body" style="padding-top: 13px">
                ...
                <form action="{{ route('dsnm_lms_tugas_update') }}" id="form-add" method="post" data-collabel="3" data-alignlabel="left">
                    {{ csrf_field() }}
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="input-group date col-md-12 tgl-tugas" data-picker-position="bottom-left">
                                            <input type="text" class="form-control" name="mulai_berlaku" value="{{ !empty($tugas->mulai_berlaku) ? Carbon::parse($tugas->mulai_berlaku)->format('d F Y h:i') : '' }}" value="{{ Carbon::now()->format('d F Y h:i') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="input-group date tgl-tugas col-md-12" data-picker-position="bottom-left">
                                            <input type="text" class="form-control" name="tgl_berakhir" value="{{ !empty($tugas->tgl_berakhir) ? Carbon::parse($tugas->tgl_berakhir)->format('d F Y h:i') : '' }}">
                                            <span class="input-group-btn">
                                                <button class="btn btn-default" type="button"><i class="fa fa-times"></i></button>
                                                <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                                            </span>
                            ...
                            <div class="col-md-4" style="padding-left: 0">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="input-group date tgl-tugas col-md-12" data-picker-position="bottom-left">
                                            <input type="text" class="form-control" name="tgl_tutup" value="{{ !empty($tugas->tgl_tutup) ? Carbon::parse($tugas->tgl_tutup)->format('d F Y h:i') : '' }}">
                                            <span class="input-group-btn">
                                                <button class="btn btn-default" type="button"><i class="fa fa-times"></i></button>
                                                <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                                            </span>
