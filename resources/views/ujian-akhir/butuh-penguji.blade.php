	...
	<div class="col-md-12">
		...
		<table border="0" width="100%" style="margin-bottom: 10px">
			<tr>
				...
				<td>
					<span class="petunjuk btn btn-warning btn-xs" title="Mahasiswa yang telah menyelesaikan bimbingannya namun penguji belum ditentukan">
				...
				<td>
					<form action="" id="form-cari">
						<div class="input-group pull-right">
							<input type="text" class="form-control input-sm mw-2 pull-right" name="cari_b" value="{{ Request::get('cari_b') }}">
