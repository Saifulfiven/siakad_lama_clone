...
@section('content')
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('kuis_jawaban', ['id_jadwal' => $r->id, 'id' => $kuis->id]) }}">Jawaban Peserta</a></li>
        ...
        <div class="col-md-12">
            ...
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <a href="{{ route('kuis_jawaban', ['id_jadwal' => $r->id, 'id' => $kuis->id]) }}" class="btn btn-default btn-sm pull-right"">Kembali</a>
                </header>
...
<script>
    ...
    $(function () {
        ...
        $('.nilai').editable({
            url: '{{ route('kuis_grade', ['id_jadwal' => $r->id, 'id_peserta' => $peserta->id_mhs_reg]) }}',
            name: 'nilai',
