...
@section('topMenu')
	<ul class="nav navbar-nav nav-top-xs hidden-xs tooltip-area">
		...
		<li><a>PEMBAYARAN KULIAH PRAKTEK</a></li>
	</ul>
@endsection
			...
			<div class="col-md-12">
				<section class="panel">
					<header class="panel-heading">
						Detail pembayaran kuliah praktek mahasiswa
						<a href="{{ route('keu_praktek') }}" class="btn btn-success btn-sm pull-right">KEMBALI</a>
					</header>
					...
					<div class="panel-body">
						...
						<div class="col-md-12">
							...
							<div class="table-responsive">
					            ...
					            <!-- History pembayaran -->
					            	<div class="col-md-12">
					            		<a href="{{ route('keu_cetak_praktek_detail', ['id' => $mhs->id_mhs_reg]) }}?smt={{ Request::get('smt') }}&jenisbayar={{ Request::get('jenisbayar') }}"
